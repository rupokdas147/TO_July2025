...
<Properties>
  <View=-1790,-1347,3542,1334,0.783593,556,679>
  <Grid=10,10,1>
  <DataSet=Gain_Stage_1.dat>
  <DataDisplay=Gain_Stage_1.dpl>
  <OpenDisplay=0>
  <Script=Gain_Stage_1.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Symbol>
  <.PortSym 40 20 1 0 VIN_P>
  <.PortSym 30 50 2 0 VIN_M>
  <.PortSym 20 80 3 0 VOUT1_P>
  <.PortSym -10 110 4 0 VOUT1_M>
</Symbol>
<Components>
  ...
  <Vdc V1 1 0 70 18 -26 0 1 "3.2 V" 1>
  <GND * 1 0 110 0 0 0 0>
  <Vdc V2 1 -350 360 18 -26 0 1 "2.05 V" 1>
  <GND * 1 -350 390 0 0 0 0>
  <Vdc V3 1 350 360 18 -26 0 1 "2.05 V" 1>
  <GND * 1 350 390 0 0 0 0>
  ...
  <Port VIN_P 1 -550 140 -23 12 0 0 "1" 1 "analog" 0>
  <Port VIN_M 1 550 140 4 12 1 2 "2" 1 "analog" 0>
  <Port VOUT1_P 1 -490 -290 -23 12 0 0 "3" 1 "analog" 0>
  <Port VOUT1_M 1 500 -290 4 12 1 2 "4" 1 "analog" 0>
  <Lib rppd1 1 -350 290 61 144 0 2 "/home/rupok/QucsWorkspace/user_lib/IHP_PDK_basic_components" 0 "rppd" 0 "15 u" 1 "2 u" 1 "1" 1>
  <Lib rppd2 1 350 290 -110 -196 0 0 "/home/rupok/QucsWorkspace/user_lib/IHP_PDK_basic_components" 0 "rppd" 0 "15 u" 1 "2 u" 1 "1" 1>
  <GND * 1 -30 0 0 0 0 0>
  ...
  <INCLSCR INCLSCR1 1 -390 -640 -60 16 0 0 ".LIB cornerHBT.lib hbt_typ\n.LIB cornerRES.lib res_wcs\n.LIB cornerCAP.lib cap_typ" 1 "" 0 "" 0>
  <GND * 1 360 -30 0 0 0 0>
  <Lib cap_rfcmim2 1 390 -30 50 -16 0 0 "/home/rupok/QucsWorkspace/user_lib/IHP_PDK_basic_components" 0 "cap_rfcmim" 0 "2.8 u" 1 "2.8 u" 1>
  <GND * 1 -420 -40 0 0 0 0>
  <Lib cap_rfcmim3 1 -390 -40 50 -16 0 0 "/home/rupok/QucsWorkspace/user_lib/IHP_PDK_basic_components" 0 "cap_rfcmim" 0 "2.8 u" 1 "2.8 u" 1>
  ...
  <SPICE X5 1 -200 -380 -251 -26 0 1 "../EM_files/30_um_10_um.ckt" 1 "_netpo1,_netpo2" 0 "yes" 0 "none" 0 "" 0>
  <SPICE X6 1 200 -380 -251 -26 0 1 "../EM_files/30_um_10_um.ckt" 1 "_netpo1,_netpo2" 0 "yes" 0 "none" 0 "" 0>
  <GND * 1 0 -410 0 0 0 0>
  <SPICE X7 1 -200 -200 -242 -26 0 1 "../EM_files/95_um_8_um.ckt" 1 "_netpo1,_netpo2" 0 "yes" 0 "none" 0 "" 0>
  <SPICE X8 1 200 -200 -242 -26 0 1 "../EM_files/95_um_8_um.ckt" 1 "_netpo1,_netpo2" 0 "yes" 0 "none" 0 "" 0>
</Components>
<Wires>
  ...
  <0 -460 200 -460 "" 0 0 0 "">
  <200 -460 200 -410 "" 0 0 0 "">
  <200 -350 200 -290 "" 0 0 0 "">
  ...
  <-200 -290 -200 -230 "" 0 0 0 "">
  <-200 -170 -200 -120 "" 0 0 0 "">
  <-550 140 -550 140 "VIN_P" -630 100 0 "">
  <550 140 550 140 "VIN_M" 580 110 0 "">
  <-490 -290 -490 -290 "VOUT1_P" -589 -340 0 "">
  <500 -290 500 -290 "VOUT1_M" 530 -320 0 "">
</Wires>
<Diagrams>
</Diagrams>
<Paintings>
