...
<Properties>
  <View=-1581,-1018,2045,928,0.935305,833,273>
  <Grid=10,10,1>
  <DataSet=Gain_Stage_2.dat>
  <DataDisplay=Gain_Stage_2.dpl>
  <OpenDisplay=0>
  <Script=Gain_Stage_2.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Symbol>
  <.PortSym 40 20 1 0 VIN2_P>
  <.PortSym 40 60 2 0 VIN2_M>
  <.PortSym 50 90 3 0 VOUT2_P>
  <.PortSym 50 130 4 0 VOUT2_M>
</Symbol>
<Components>
  ...
  <Port VIN2_P 1 -550 140 -23 12 0 0 "1" 1 "analog" 0>
  <Port VIN2_M 1 550 140 4 12 1 2 "2" 1 "analog" 0>
  <Port VOUT2_P 1 -490 -290 -23 12 0 0 "3" 1 "analog" 0>
  <Port VOUT2_M 1 500 -290 4 12 1 2 "4" 1 "analog" 0>
  ...
  <GND * 1 320 220 0 0 0 0>
  <INCLSCR INCLSCR1 1 -467 -658 -60 16 0 0 ".LIB cornerHBT.lib hbt_typ\n.LIB cornerRES.lib res_wcs\n.LIB cornerCAP.lib cap_typ" 1 "" 0 "" 0>
  <GND * 1 -420 -40 0 0 0 0>
  <GND * 1 360 -50 0 0 0 0>
  <Lib cap_rfcmim1 1 -390 -40 50 -16 0 0 "/home/rupok/QucsWorkspace/user_lib/IHP_PDK_basic_components" 0 "cap_rfcmim" 0 "2 u" 1 "2.8 u" 1>
  <Lib cap_rfcmim2 1 390 -50 50 -16 0 0 "/home/rupok/QucsWorkspace/user_lib/IHP_PDK_basic_components" 0 "cap_rfcmim" 0 "2 u" 1 "2.8 u" 1>
  ...
  <SPICE X7 1 200 -360 -242 -26 0 1 "../EM_files/25_um_10_um.ckt" 1 "_netpo1,_netpo2" 0 "yes" 0 "none" 0 "" 0>
  <GND * 1 -170 -360 0 0 0 0>
  <SPICE X8 1 -200 -360 -242 -26 0 1 "../EM_files/25_um_10_um.ckt" 1 "_netpo1,_netpo2" 0 "yes" 0 "none" 0 "" 0>
</Components>
<Wires>
  ...
  <390 -20 390 40 "" 0 0 0 "">
  <0 -460 200 -460 "" 0 0 0 "">
  <200 -460 200 -390 "" 0 0 0 "">
  <200 -330 200 -290 "" 0 0 0 "">
  <-200 -460 0 -460 "" 0 0 0 "">
  <-200 -460 -200 -390 "" 0 0 0 "">
  <-200 -330 -200 -290 "" 0 0 0 "">
  <-550 140 -550 140 "VIN2_P" -638 100 0 "">
  <550 140 550 140 "VIN2_M" 580 110 0 "">
  <-490 -290 -490 -290 "VOUT2_P" -589 -340 0 "">
  <500 -290 500 -290 "VOUT2_M" 530 -320 0 "">
</Wires>
<Diagrams>
</Diagrams>
<Paintings>
